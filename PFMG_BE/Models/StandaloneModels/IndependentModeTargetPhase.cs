...
{
    public class IndependentModeTargetPhase
    {
        // PK: phase_id
        [Key]
        ...
        [ForeignKey("IndependentModeJamming")]
        public int IndependentModeJammingId { get; set; }
        public IndependentModeJamming IndependentModeJamming { get; set; }


        public static IndependentModeTargetPhase ToEntity(TargetPhaseDto dto) =>
