...
{
    public class IndependentTargetPhase
    {
        // PK: phase_id
        [Key]
        ...
        [ForeignKey("IndependentJamming")]
        public int IndependentJammingId { get; set; }
        public IndependentJamming IndependentJamming { get; set; }

        public static IndependentTargetPhase ToEntity(TargetPhaseDto dto) =>
